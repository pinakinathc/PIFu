...
def gen_mesh(opt, net, cuda, data, save_path, use_octree=True):
    ...
    try:
        ...
        net.module.filter(image_tensor)
    ...
    try:
        ...
        verts, faces, _, _ = reconstruction(
            net, cuda, calib_tensor, pos_emb_tensor, opt.resolution, b_min, b_max)

        ''' Uncomment the below lines to use different reconstruction techniques '''
        # ndf_reconstruction(
        #     net, cuda, calib_tensor, pos_emb_tensor, opt.resolution, b_min, b_max)

        # verts, faces = ndf_template_reconstruction(
        #     net, cuda, calib_tensor, pos_emb_tensor, opt.resolution, b_min, b_max)
